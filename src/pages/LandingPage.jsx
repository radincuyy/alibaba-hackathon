    ...
    return (
        <div className="min-h-screen bg-cream-100">
            ...
            <main>
                ...
                {/* CTA Section */}
                <section id="cta" className="py-24 md:py-32" aria-label="Call to action">
                    <div className="max-w-7xl mx-auto px-6 lg:px-8">
                        <div className="card bg-cream-900 text-cream-50 p-10 md:p-16 lg:p-20 text-center relative overflow-hidden">
                            {/* Decorative elements */}
                            <div className="absolute top-0 right-0 w-80 h-80 bg-accent/10 rounded-full blur-[100px]" aria-hidden="true" />
                            <div className="absolute bottom-0 left-0 w-60 h-60 bg-accent/5 rounded-full blur-[80px]" aria-hidden="true" />
